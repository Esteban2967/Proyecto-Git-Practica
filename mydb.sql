...
CREATE TABLE IF NOT EXISTS `mydb`.`habitaciones` (
  ...
  INDEX `fk_habitaciones_camas1_idx` (`camas_idcamas` ASC) VISIBLE,
  INDEX `fk_habitaciones_categorias1_idx` (`categorias_idcategorias` ASC) VISIBLE,
  CONSTRAINT `fk_habitaciones_camas1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`reservas` (
  ...
  INDEX `fk_reservas_recepcionistas1_idx` (`recepcionistas_idrecepcionistas` ASC) VISIBLE,
  CONSTRAINT `fk_reservas_clientes1`
    FOREIGN KEY (`clientes_idclientes`)
    REFERENCES `mydb`.`clientes` (`idclientes`)
    ON UPDATE CASCADE,
  CONSTRAINT `fk_reservas_recepcionistas1`
